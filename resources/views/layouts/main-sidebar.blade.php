    ...
    <div class="main-sidemenu">
        <div class="app-sidebar__user clearfix">
            <div class="dropdown user-pro-body">
                <a class="profile-user d-flex" href="{{ url('/' . ($page = 'profile')) }}">
        ...
        <ul class="side-menu">
            ...
            @can('الفواتير')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @can('قائمة الفواتير')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'invoices')) }}">جميع الفواتير</a></li>
                        @endcan
                        ...
                        @can('الفواتير المدفوعة جزئيا')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'Partially_invoices')) }}">الفواتير المدفوعة
                                    جزئيا</a></li>
                        @endcan
                        @can('ارشيف الفواتير')
            ...
            @can('التقارير')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @can('تقرير الفواتير')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'reports_invoices')) }}">تقارير الفواتير</a></li>
                        @endcan
                        @can('تقرير العملاء')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'reports_customers')) }}">تقارير العملاء</a>
                            </li>
                        @endcan
                    </ul>
                </li>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @can('قائمة المستخدمين')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'users')) }}">جميع المستخدمين</a></li>
                        @endcan
            ...
            @can('الاعدادات')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @can('الاقسام')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'section')) }}">اضافة قسم</a></li>
                        @endcan
                        @can('المنتجات')
