                    ...
                    <form action="{{ route('status_update', $invoice->id) }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" readonly id="inputName" name="invoice_number"
                                    value="{{ $invoice->invoice_number }}" title="يرجي ادخال رقم الفاتورة">
                            </div>

                            <div class="col">
                                <label>تاريخ الفاتورة</label>
                                <input class="form-control fc-datepicker" readonly name="invoice_Date"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" readonly id="inputName" name="Section"
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" readonly id="inputName" name="product"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" readonly class="form-control form-control-lg" id="Amount_Commission"
                                    name="Amount_Commission" value="{{ $invoice->Amount_Commission }}">
                            </div>

                            <div class="col">
                                <label for="inputName" class="control-label">الخصم</label>
                                <input type="text" readonly class="form-control form-control-lg" id="Discount"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" readonly class="form-control" id="Value_VAT" name="Value_VAT"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea class="form-control" readonly id="exampleTextarea" name="note" rows="2">{{ $invoice->note }}</textarea>
                            </div>
                        </div>
                        {{-- 6 --}}
                        <div class="row">
                            <div class="col">
                                <label for="inputName" class="control-label">حدد حالة الدفع</label>
                                <select class="form-control" id="Status" name="Status" required>
                                    ...
                                    <option value="مدفوعة جزئيا" {{ $invoice->Status == 'مدفوعة جزئيا' ? 'selected' : '' }}>مدفوعة جزئيا</option>
                                </select>
                            </div>
