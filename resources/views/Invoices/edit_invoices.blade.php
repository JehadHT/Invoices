                    ...
                    <form action="{{ route('invoices.update' , $invoice->id) }}" method="post" enctype="multipart/form-data"
                            ...
                            <div class="col">
                                ...
                                <select name="Section" class="form-control SlectBox" onclick="console.log($(this).val())"
                                    ...
                                    @foreach ($sections as $section)
                                        <option value="{{ $section->id }}" {{ $section->id == $invoice->section_id ? 'selected' : '' }}> {{ $section->section_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea class="form-control" id="exampleTextarea" name="note" rows="2">{{ $invoice->note }}</textarea>
                            </div>
                        </div><br>
